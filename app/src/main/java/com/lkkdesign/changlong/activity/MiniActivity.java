...
import com.lkkdesign.changlong.baidutts.control.InitConfig;
import com.lkkdesign.changlong.baidutts.listener.UiMessageListener;
import com.lkkdesign.changlong.baidutts.util.AutoCheck;
...
public class MiniActivity extends AppCompatActivity {
    ...
    private String TEXT = "欢迎使用百度语音合成，请在代码中修改合成文本";
     ...
     */
    protected String appId = "15279010";
    protected String appKey = "ZXAYB8uf3yZQ2ygtZEVYWthm";
    protected String secretKey = "vAd1E1oECYmCfSfZGC96P8PVE60ZQVDj";

    // TtsMode.MIX; 离在线融合，在线优先； TtsMode.ONLINE 纯在线； 没有纯离线
//    private TtsMode ttsMode = TtsMode.ONLINE;
    private TtsMode ttsMode = TtsMode.MIX;//开启离线功能
    ...
    private void speak() {
        ...
        TEXT = etTTS.getText().toString();
        int result = mSpeechSynthesizer.speak("AV女优，是指日本专门从事成人电影演出的女性演员。AV是“Adult Video”的缩写，也就是成人录像。“优”就是演员之意，男为优女为伶，均指戏子之意，但在传入日本以后，日本人将优伶一概而论，故只保留了优。受欢迎的女神有穗花，前岛美步，立花里子，宫路直美，松岛枫，及川奈央，夏目奈奈，苍井空，吉泽明步，小泽玛丽亚，长泽筑实，麻美由真");
        mShowText.setText("");
        print("合成并播放 按钮已经点击");
    ...
    private void initView() {
        ...
        etTTS = (EditText) this.findViewById(R.id.et_tts);
