...
// * </p>
// * Created by huangyaoyu on 2017/7/22.
// */
//public abstract class BaseDragActivity extends BaseSMRecycleViewActivity {
//
...
//                if (0 == menuPosition) {
////                    intent.setClass(BaseDragActivity.this, DataManageActivity.class);
////                    intent.putExtra("curve", mDataList.get(position)); //将计算的值回传回去
////                    startActivity(intent);
//                }
//                Log.i("BDActivity", "position=" + position);
//                Log.i("BDActivity", "mDataList=" + mDataList.toString());
//                Log.i("BDActivity", "Curve=" + mDataList.get(position - 1));
////                Toast.makeText(BaseDragActivity.this, "list第" + position + "; 右侧菜单第" + menuPosition, Toast.LENGTH_SHORT)
////                    .show();
//                Toast.makeText(BaseDragActivity.this, "position=" + position + "\n menuPosition=" + menuPosition, Toast.LENGTH_SHORT)
//                        .show();
