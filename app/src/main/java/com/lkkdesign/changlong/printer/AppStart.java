...
import com.lkkdesign.changlong.activity.SettingsActivity;
...
public class AppStart extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start_private_print);
...
//        getLocation();
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btnTestBT: {
                intent.setClass(AppStart.this, SearchBTActivity.class);
                startActivity(intent);
                break;
            }

            case R.id.btnTestBLE: {
                intent.setClass(AppStart.this, SearchBLEActivity.class);
                startActivity(intent);
                break;
            }

            case R.id.btnTestUSB: {
                intent.setClass(AppStart.this, ConnectUSBActivity.class);
                startActivity(intent);
                break;
            }

            case R.id.btnTestNET: {
                intent.setClass(AppStart.this, ConnectIPActivity.class);
                startActivity(intent);
                break;
            }
        }
...
//    }
    ...
    public void onBackPressed() {
        ...
        intent.setClass(AppStart.this, SettingsActivity.class);
        startActivity(intent);
