package com.lkkdesign.changlong.excel;
...
//        File dir = new File("/storage/sdcard0/ChangLongData");
        ...
        WritableSheet sheet = wwb.createSheet("订单", 0);//工作表的名称
        Label label;
...
//            Toast.makeText(context, "写入成功", Toast.LENGTH_LONG).show();
        ...
        // 关闭文件
        wwb.close();
        CustomToast.showToast(context,"写入成功");
    }
